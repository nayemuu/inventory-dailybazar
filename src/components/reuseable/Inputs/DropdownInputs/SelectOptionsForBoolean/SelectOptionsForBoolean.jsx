...
import "./SelectOptionsForBoolean.css";
import SelectOptionsForBooleanItem from "./SelectOptionsForBooleanItem";

const SelectOptionsForBoolean = ({
  label,
  value,
  setValue,
  required,
...
export default SelectOptionsForBoolean;
