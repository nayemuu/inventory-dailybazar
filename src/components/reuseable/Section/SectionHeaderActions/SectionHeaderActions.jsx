...
const SectionHeaderActions = (props) => {
  ...
  const [hoveredOnSearchIcon, setHoveredOnSearchIcon] = useState(false);
  return (
    <div>
      <div className="flex justify-between items-center gap-5 flex-wrap mb-3">
        <div className="grow">
          <div className="flex justify-start items-center gap-5">
            <div
              className="text-lg font-bold cursor-pointer hover:text-primary-deep"
            ...
            <div className="relative h-[43px] w-full max-w-[500px] flex justify-start items-center">
              <div className="h-full w-[50px] flex justify-center items-center absolute left-[0px]">
                <div
                  className="text-xl font-extrabold cursor-pointer hover:text-primary-deep duration-300"
                  onMouseEnter={() => setHoveredOnSearchIcon(true)}
                  onMouseLeave={() => setHoveredOnSearchIcon(false)}
                >
                  <svg
                    width="24"
                    height="25"
                  ...
                  >
                    <path
                      ...
                      fill={
                        hoveredOnSearchIcon ? 'var(--primary-color)' : '#637381'
                      }
                    />
                  </svg>
                </div>
