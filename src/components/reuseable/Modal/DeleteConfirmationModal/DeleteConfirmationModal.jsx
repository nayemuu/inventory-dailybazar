...
const DeleteConfirmationModal = ({ setShow, handler, title, message }) => {
  const handleClick = () => {
    handler();
  };
  ...
  return (
    <div className="flex justify-center items-center mt-[10vh]">
      <div className="bg-[#FFFFFF] delete-modal-container rounded-[7px] m-5">
        <div className="bg-[#E40000] h-[10px] rounded-t-[7px]"></div>

        <div className="flex gap-3 sm:gap-5 p-[30px] items-center">
          <div className="delete-modal-logo-container">
            <svg
              width="50"
              height="50"
              viewBox="0 0 50 50"
