  ...
  return (
    <div className="flex justify-center items-center mt-[10vh]">
      <div className="bg-[#FFFFFF] DeleteModalContainer rounded-[7px] m-5">
        <div className="bg-[#B55930] h-[10px] rounded-t-[7px]"></div>
        ...
        <div className="flex flex-wrap gap-3 p-[16px] sm:p-[20px] justify-end">
          <button
            className="text-[#3E3E3E] bg-[#F3F6FA] border-[1px] border-[#B55930] hover:bg-black/10 py-[10px] px-[22px] sm:px-[26px] font-semibold rounded-[50px] text-xs sm:text-base"
            onClick={() => setShow(false)}
          >
            No
          </button>
          <button
            className="bg-[#B55930] hover:from-[#D13F96]/80 hover:to-[#833586]/80  text-white py-[10px] px-[22px] sm:px-[26px] font-semibold rounded-[50px] text-xs sm:text-base"
            onClick={handleClick}
          >
            Yes
          </button>
